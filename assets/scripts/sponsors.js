let sponsorlink = 'https://script.google.com/macros/s/AKfycbxLyjCzLzQKkUBHOtDzVnAs8pGozwicf4cWY98v2SL9AqE7WvWKvQbocmylHz5dQuzgaA/exec';
async function getSponsor() {
    ...
    for (let i = 1; i < data.length; i++) {
        ...
        if (tier === "Pearl") {
            ...
            gold += `<div class='col-12 col-lg-4 gold p-2'>${sponsorData}`
        }
        else if (tier === "Silver") {
    ...
    return html + pearl + closeDiv + gold + closeDiv + silver + closeDiv + custom + closeDiv + closeDiv;
}
